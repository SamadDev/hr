...
class TextFieldV2Widget extends StatelessWidget {
  TextFieldV2Widget({
    Key key,
    this.labelText,
    this.errorText,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: labelText == null ? 0 : 5,),
          Container(
          ...
          isRequired == true && isSubmit == true && initialValue == null
              ? Container(
