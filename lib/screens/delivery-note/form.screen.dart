...
import 'package:nandrlon/screens/delivery-note/item.screen.dart';
...
class DeliveryNoteFormScreen extends StatefulWidget {
  ...
  @override
  _DeliveryNoteFormScreenState createState() => _DeliveryNoteFormScreenState();
}
                  ...
                  children: [
                      ...
                      widget: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: TextFieldWidget(
                                      ...
                                      initialValue:
                                          _deliveryNote.deliveryNo ?? "",
                                      keyboardType: TextInputType.number,
                                      onChanged: (value) {
                                        _deliveryNote.deliveryNo = value;
                                      },
                                    ),
                                  ),
                                  SizedBox(
                            ...
                            GestureDetector(
                              onTap: () => widget.salesOrderId != null
                                  ? null
                                  : customerModalBottomSheet(context),
                              child: TextFieldWidget(
                                labelText: "Customer",
                                isDropdown:
                                    widget.salesOrderId != null ? false : true,
                                key: Key(_deliveryNote.customer?.name),
                                enabled: false,
                                isRequired: true,
                                initialValue:
                                    _deliveryNote.customer?.name ?? "",
                              ),
                            ),
                            DropdownButtonWidget(
                              labelText: "Warehouse",
                              value: _deliveryNote.warehouse,
                              items: _warehouses.map((Warehouse warehouse) {
                              ...
                              onChanged: (Warehouse warehouse) {
                                setState(() {
                                  _deliveryNote.warehouse = warehouse;
                                  _deliveryNote.warehouseId = warehouse.id;
                                });
                              },
                            ),
                          ],
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              InkWell(
                                onTap: () async {
                                  var itemResult = await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) =>
                                  ...
                                  if (itemResult != null) {
                                    setState(() {
                                      ...
                                      _deliveryNoteDetail.id = 0;
                                      _deliveryNoteDetail.quantity = 0;
                                      _deliveryNoteDetail.entityMode =
                                          EntityMode.New;
                                      _deliveryNoteDetail.itemId =
                                          itemResult.id;
                                      _deliveryNoteDetail.item = itemResult;
                                    });
                    ...
                    FormListTile(
                      ...
                      widget: Container(
                        ...
                        child: TextFieldWidget(
                          labelText: "Description",
                          initialValue: _deliveryNote.description,
                          onChanged: (description) {
                            setState(() {
                              _deliveryNote.description = description;
                            });
                          },
                          maxLines: 2,
                        ),
